    ...
    return (
      ...
      >
        <Paragraph>
          ...
          any part of the app, or my trademarks in any way. You’re not allowed
          ...
          derivative versions unless specified by Pavandeep Sidhu. The app
          itself, and all the trade marks, copyright, database rights and other
          intellectual property rights related to it, still belong to Pavandeep
          Sidhu.
        </Paragraph>
        <Paragraph>
          Pavandeep Sidhu is committed to ensuring that the app is as useful and
        ...
        <Paragraph>
          The DayNote app stores and processes personal data that you have
          ...
          DayNote app won’t work properly or at all.
        </Paragraph>
        <Paragraph>
          You should be aware that there are certain things that Pavandeep Sidhu
          ...
          Pavandeep Sidhu cannot take responsibility for the app not working at
        ...
        <Paragraph>
          Along the same lines, Pavandeep Sidhu cannot always take
          ...
          can’t turn it on to avail the Service, Pavandeep Sidhu cannot accept
          responsibility
        </Paragraph>
        <Paragraph>
          With respect to Pavandeep Sidhu’s responsibility for your use of the
          ...
          that we can make it available to you. Pavandeep Sidhu accepts no
        ...
        <Paragraph>
          ...
          available on Android – the requirements for this system (and for any
          ...
          keep using the app. Pavandeep Sidhu does not promise that it will
        ...
        <Paragraph style={styles.subtitle}>Contact Me</Paragraph>
        <Paragraph>
